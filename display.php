...
<head><title>LogicalMatrixGames</title>
	...
	<link rel = "stylesheet" type = "text/css" href = "style.css?lastVersion=19.7">
	<link rel = "SHORTCUT ICON" href = "img/icon.png">
	<script defer type = 'text/javascript' language = "JavaScript" src = 'lang.js?lastVersion=1.3'></script>
	<script defer type = 'text/javascript' language = "JavaScript" src = 'function.js?lastVersion=14.1'></script>
	...
	<div id = 'body'>
		...
		<div id = 'bottom' class = 'windowSite'>
			...
			<div id = 'sateVersion'>
				...
				<? echo (_l('Regards Minin Aleksandr!'))?> (v14 - 09.05.2021)</p>
			</div>
		</div>
	</div>
