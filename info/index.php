...
switch($_GET["lang"]){
    case "eng":
		...
		<ul class = 'gameCheckbox key'><li class = 'deletedGameCheckbox'></li><li class = 'deletedGameCheckbox'></li><li class = 'deletedGameCheckbox'></li></ul> - a scale displays life expectancy of game after last best result. If last scale item is red so game will be removed soon.<br>
