...
switch($_GET["lang"]){
    case "eng":
		...
		<table>
			...
			<tr><td><img src = 'img/k_profile.png' alt='Your profile'/></td><td>
				- your personal page, here you can read and send messages to other users,
        change your data and monitor your progress. </td></tr>
		    <tr><td><img src = 'img/letter.png' alt='Letter'/></td><td> - sometimes you can see an letter
         that means you have one or more unread messages.<td></tr>
        ...
        if in the game, then according to the results of records and medals collected for the whole time.</td></tr>
		 ...
		 <br>
        The widget of social network VKontakte - if you liked this site, be sure to click on it
        ...
        To compete, you can to choose a game from the tournament table or select it directly in the game
    ...
    default:
		...
		<table>
			...
			<tr><td><img src = 'img/k_profile.png' alt='Your profile'/><div class = 'letter'></div></td><td>
			 - ваша личная страница, здесь можно читать и отправлять сообщения другим пользователям,
		изменять свои данные и наблюдать за своими достижениями.</td></tr>
		 ...
		 это означает, что у вас есть одно или несколько непрочитанных сообщений.</td></tr>
			<tr><td><img src = 'img/k_stat.png' alt='Statistic'/></td><td> - статистика в зависимости от того где вы находитесь,
		если вы у себя на странице - то информация будет по вашим наградам,
		если в игре то по результатам рекордов и набранных медалей за все время.</td></tr>
		...
		&nbsp&nbsp&nbsp&nbsp
		Рейтинг сайта - список играков в левом окне страницы - баллы там начисляются за хорошо сыгранные партии.
		...
		Для соревнования вы можите выбрать игру из турнирной таблицы или выбрать ее непосредственно в игре
