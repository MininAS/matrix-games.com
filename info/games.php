...
switch($_GET["lang"]){
    case "eng":
		...
		Move mouse over and you will see if you can choose a game
		 - it must not be started or have the best result by you, as the following markers will tell you:<br>
		...
		<ul class = 'gameCheckbox key'><li class = 'deletedGameCheckbox'></li><li class = 'deletedGameCheckbox'></li><li class = 'deletedGameCheckbox'></li></ul>
		 - a scale displays life expectancy of game after last best result. If last scale item is red so game will be removed soon.<br>
    ...
    default:
    	?>
		&nbsp&nbsp&nbsp&nbsp
		С лева список с играми, варианты которых были оставлены другими игроками. Каждая из таких игр, имеет свой список сохраненных подигр,
		 что есть попытки одной и той же комбинации поля. Наведите курсор и вы увидите можете ли вы выбрать игру
		 – она не должна быть начата вами или иметь лучший результат ваш, о чем вам подскажут следующие маркеры:<br>
		<ul class = 'gameCheckbox key'><li class = 'openedGameCheckbox'></li></ul> - укажет на количество, уже сохранненых вами игр.<br>
		...
		<ul class = 'gameCheckbox key'><li class = 'deletedGameCheckbox'></li><li class = 'deletedGameCheckbox'></li><li class = 'deletedGameCheckbox'></li></ul>
		 - шкала отображает продолжительность жизни игры после последнего лучшего результата. Если последний элемент шкалы красный, игра скоро будет удалена.<br>
		...
		которая была у игрока, который ее открыл. А смысл в том, что игра будет честной, и совершенно не зависеть от разного расклада фишек.<br>
		<br>
        Правила этой игры:
		<br>
		<?php
